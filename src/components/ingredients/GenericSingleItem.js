...
const ItemDetails = ({ item, extraContent }) => (
...
const GenericSingleItem = ({ fetchFn, extraContent, authState }) => {
    ...
    return (
        <div className="single-page">
            <How />
            <ItemDetails item={item} extraContent={typeof extraContent === 'function' ? extraContent(item) : extraContent} />
        </div>
    );
};

export default withAuth(GenericSingleItem);
